...
HOMEBREW_TAP_PATH="$HOME/projects/homebrew-tap"
...
main() {
    ...
    cd app/tui && go build -o slaygent-manager && cd ../..
    cd app/messenger && go build -o msg && cd ../..
    print_success "Build successful"

    # Clean up test builds
    rm -f app/tui/slaygent-manager app/messenger/msg
    ...
    if [[ -f $FORMULA_FILE ]]; then
        # Update URL and SHA256 in formula (Linux-compatible sed)
